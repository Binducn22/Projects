public class OnlineClothing{
    ...
    public static void main(String[] args) {
        OnlineClothing.kurti("AVAASA", 1299.29);
        OnlineClothing.tops("Levi's", "BLACK", 'M', 2999.99);
        OnlineClothing.cropTop("ZUDIO", 599.78645, "SLEEVELESS");
        OnlineClothing.bottomWear("DNMX", 999.9999, "MOM-FIT", 34);
        OnlineClothing.dress("LOV", 2149.89, "A-LINE", 30096353);
    }
}